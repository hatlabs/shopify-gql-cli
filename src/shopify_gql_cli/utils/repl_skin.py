"""REPL Skin — Terminal interface for shopify-gql-cli."""
...
class ReplSkin:
    ...
    def _detect_color_support(self):
        if os.environ.get("NO_COLOR"):
            return False
        if os.environ.get("SHOPIFY_GQL_CLI_NO_COLOR"):
            return False
    ...
    def print_banner(self):
        ...
        brand = self._c(_CYAN + _BOLD, "shopify-gql-cli")
    ...
    def status_block(self, items, title=""):
        if title:
            self.section(title)
